...
[ ! -f $SRC_DIR/mariadb-5.5.38.tar.gz ] && wget -c http://ftp.osuosl.org/pub/mariadb/mariadb-5.5.38/source/mariadb-5.5.38.tar.gz -O $SRC_DIR/mariadb-5.5.38.tar.gz
