...
then
   ...
   tar -zxvf  $_package
   cd flvtool2-1.0.6/
   /usr/local/avpffmpeg/bin/ruby setup.rb config
   /usr/local/avpffmpeg/bin/ruby setup.rb setup
   /usr/local/avpffmpeg/bin/ruby setup.rb install
   ln -s /usr/local/avpffmpeg/bin/flvtool2 /usr/local/bin/flvtool2
   ln -s /usr/local/avpffmpeg/bin/flvtool2 /usr/bin/flvtool2
   echo -e $RED"
                        :rvri                     
                  :vJUJYri:::::i::                
            .sDgEJi                 r7i           
